...
abstract class Factory54 implements Factory54Interface {
    ...
    public function neew(string $class, string $type=null) {
        $args = array();
    ...
    protected function instantiate(string $class, string $type=null, string $action, array $args) {
        ...
        if ($instance instanceof \KS\Factory54ConsumerInterface) $instance->setFactory($this);
